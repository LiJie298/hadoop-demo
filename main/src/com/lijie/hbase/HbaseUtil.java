...
public class HbaseUtil {
    ...
    //连接集群
    private Connection initHbase() throws IOException {
...
//        configuration.set("hbase.zookeeper.quorum", "127.0.0.1");
        ...
        configuration.set("fs.defaultFS", "127.0.0.1:9000/hbase");
        configuration.set("hbase.master", "127.0.0.1");
        Connection connection = ConnectionFactory.createConnection(configuration);
        return connection;
    }

    //创建表
    private void createTable(String tableNmae, String[] cols) throws IOException {
    ...
    //插入数据
    private void insertData(String tableName, User user) throws IOException {
    ...
    //获取原始数据
    private void getNoDealData(String tableName) {
        try {
    ...
    //根据rowKey进行查询
    private User getDataByRowKey(String tableName, String rowKey) throws IOException {
    ...
    //查询指定单cell内容
    private String getCellData(String tableName, String rowKey, String family, String col) {
    ...
    //查询指定表名中所有的数据
    private List<User> getAllData(String tableName) {
    ...
    //删除指定cell数据
    private void deleteByRowKey(String tableName, String rowKey) throws IOException {
